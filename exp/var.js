...
let learning_stimuli = [
    ...
    {stimulus: stim_shuffle[9],  stimulus2: null,              data: {test_part: 'learning', reaction: 'no-reaction', condition: 'single-negative',               correct_response: 48, incorrect_response: 49, stim_left: stim_shuffle[9].slice(8), stim_right: '', version: version}}, // 0 key
    {stimulus: stim_shuffle[10], stimulus2: null,              data: {test_part: 'learning', reaction: 'allergy',     condition: 'single-positive',               correct_response: 49, incorrect_response: 48, stim_left: stim_shuffle[10].slice(8), stim_right: '', version: version}}, // 1 key
...
let blocking_stimuli = [
    ...
    {stimulus: stim_shuffle[10], stimulus2: null,              data: {test_part: 'blocking', reaction: 'allergy',     condition: 'consistent-allergy',            correct_response: 49, incorrect_response: 48, stim_left: stim_shuffle[10].slice(8), stim_right: ''}}, // 1 key
